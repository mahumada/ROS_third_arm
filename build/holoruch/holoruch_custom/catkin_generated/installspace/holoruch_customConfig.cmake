...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'holoruch_custom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/manuel/catkin_ws/install/${idir}'.  Ask the maintainer 'Andreas Bihlmaier <andreas.bihlmaier@gmx.de>' to fix it.")
    endif()
